...
class _TaskEditPageWidgetState extends State<TaskEditPageWidget> {
  ...
  void initState() {
    ...
    _model.textFieldEquipmentFocusNode1 ??= FocusNode();

    _model.textFieldEquipmentFocusNode2 ??= FocusNode();
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            await launchURL(
                                                'https://yandex.ru/maps/?mode=search&text=${_model.textController2.text}');
                                          },
                                        ),
                                      ],
                                    ),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                                  .textFieldEquipmentTextController1 ??=
                                              TextEditingController(
                                            text: columnTasksRow?.equipmentId,
                                          ),
                                          focusNode: _model
                                              .textFieldEquipmentFocusNode1,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                          ...
                                          keyboardType: TextInputType.phone,
                                          validator: _model
                                              .textFieldEquipmentTextController1Validator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                                  .textFieldEquipmentTextController2 ??=
                                              TextEditingController(
                                            text:
                                                columnTasksRow?.equipmentModel,
                                          ),
                                          focusNode: _model
                                              .textFieldEquipmentFocusNode2,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                          ...
                                          keyboardType: TextInputType.phone,
                                          validator: _model
                                              .textFieldEquipmentTextController2Validator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                            ...
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    ...
                                                    TextEditingController(
                                                  text:
                                                      columnTasksRow?.taskDoer,
                                                ),
                                                focusNode:
                                                    _model.textDoerFocusNode,
                                                autofocus: false,
                                                readOnly: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                ...
                                                keyboardType:
                                                    TextInputType.phone,
                                                validator: _model
                                                    .textDoerTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ),
