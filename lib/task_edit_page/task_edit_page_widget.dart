...
class _TaskEditPageWidgetState extends State<TaskEditPageWidget> {
  ...
  void initState() {
    ...
    _model.textDoerNameFocusNode ??= FocusNode();
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller: _model.textController2 ??=
                                            TextEditingController(
                                          text: columnTasksRow?.locationAddress,
                                        ),
                                      ...
                                      builder: (context) => InkWell(
                                        ...
                                        onTap: () async {
                                          await showDialog(
                                            ...
                                            builder: (dialogContext) {
                                              ...
                                              () => _model.doerName = value));

                                          if (_model.doerName != null &&
                                              _model.doerName != '') {
                                            safeSetState(() {
                                              _model.textDoerNameTextController
                                                  ?.text = _model.doerName!;
                                            });
                                          }
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                      .textDoerNameTextController ??=
                                                  TextEditingController(
                                                text: columnTasksRow?.taskDoer,
                                              ),
                                              focusNode:
                                                  _model.textDoerNameFocusNode,
                                              autofocus: false,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                isDense: true,
                                              ...
                                              keyboardType: TextInputType.phone,
                                              validator: _model
                                                  .textDoerNameTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                  ...
                                  onPressed: () async {
                                    await TasksTable().update(
                                      data: {
                                        ...
                                        'task_doer': _model
                                            .textDoerNameTextController.text,
                                        'task_category':
