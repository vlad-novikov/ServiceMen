...
import 'report_page_copy_model.dart';
export 'report_page_copy_model.dart';
...
class _ReportPageCopyWidgetState extends State<ReportPageCopyWidget> {
  late ReportPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportPageCopyModel());
