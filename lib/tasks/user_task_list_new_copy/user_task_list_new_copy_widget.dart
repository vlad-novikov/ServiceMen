...
import 'user_task_list_new_copy_model.dart';
export 'user_task_list_new_copy_model.dart';

class UserTaskListNewCopyWidget extends StatefulWidget {
  const UserTaskListNewCopyWidget({super.key});

  static String routeName = 'UserTaskListNewCopy';
  static String routePath = '/mytasks1';

  @override
  State<UserTaskListNewCopyWidget> createState() =>
      _UserTaskListNewCopyWidgetState();
}

class _UserTaskListNewCopyWidgetState extends State<UserTaskListNewCopyWidget> {
  late UserTaskListNewCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserTaskListNewCopyModel());
