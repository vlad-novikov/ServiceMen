...
import '/index.dart';
import 'user_task_list_copy3_widget.dart' show UserTaskListCopy3Widget;
import 'package:flutter/material.dart';

class UserTaskListCopy3Model extends FlutterFlowModel<UserTaskListCopy3Widget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in UserTaskListCopy3 widget.
