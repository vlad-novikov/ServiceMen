...
import 'user_task_list_copy4_model.dart';
export 'user_task_list_copy4_model.dart';

class UserTaskListCopy4Widget extends StatefulWidget {
  const UserTaskListCopy4Widget({super.key});

  static String routeName = 'UserTaskListCopy4';
  static String routePath = '/mytasks4';

  @override
  State<UserTaskListCopy4Widget> createState() =>
      _UserTaskListCopy4WidgetState();
}

class _UserTaskListCopy4WidgetState extends State<UserTaskListCopy4Widget> {
  late UserTaskListCopy4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserTaskListCopy4Model());
                    ...
                    child: Align(
                      ...
                      child: FutureBuilder<List<TasksRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<TasksRow> contentTasksRowList = snapshot.data!;
                                                                    ...
                                                                    Flexible(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            (userTasksItem.taskCategory!).substring(0,
                                                                                3),
