...
import '/index.dart';
import 'user_task_list_new_widget.dart' show UserTaskListNewWidget;
import 'package:flutter/material.dart';

class UserTaskListNewModel extends FlutterFlowModel<UserTaskListNewWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in UserTaskListNew widget.
