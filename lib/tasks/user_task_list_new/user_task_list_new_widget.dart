...
import 'user_task_list_new_model.dart';
export 'user_task_list_new_model.dart';

class UserTaskListNewWidget extends StatefulWidget {
  const UserTaskListNewWidget({super.key});

  static String routeName = 'UserTaskListNew';
  static String routePath = '/mytasks';

  @override
  State<UserTaskListNewWidget> createState() => _UserTaskListNewWidgetState();
}

class _UserTaskListNewWidgetState extends State<UserTaskListNewWidget> {
  late UserTaskListNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserTaskListNewModel());
