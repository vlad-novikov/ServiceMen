...
import '/index.dart';
import 'user_task_scroll_widget.dart' show UserTaskScrollWidget;
import 'package:flutter/material.dart';

class UserTaskScrollModel extends FlutterFlowModel<UserTaskScrollWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in UserTaskScroll widget.
