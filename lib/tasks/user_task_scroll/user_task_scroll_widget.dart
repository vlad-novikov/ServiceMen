...
import 'user_task_scroll_model.dart';
export 'user_task_scroll_model.dart';

class UserTaskScrollWidget extends StatefulWidget {
  const UserTaskScrollWidget({super.key});

  static String routeName = 'UserTaskScroll';
  static String routePath = '/scroll';

  @override
  State<UserTaskScrollWidget> createState() => _UserTaskScrollWidgetState();
}

class _UserTaskScrollWidgetState extends State<UserTaskScrollWidget> {
  late UserTaskScrollModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserTaskScrollModel());
                                                                  ...
                                                                  Flexible(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          (userTasksItem.taskCategory!).substring(
                                                                              0,
                                                                              3),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .titleSmall
