...
import '/index.dart';
import 'user_task_list_new_copy2_widget.dart' show UserTaskListNewCopy2Widget;
import 'package:flutter/material.dart';

class UserTaskListNewCopy2Model
    extends FlutterFlowModel<UserTaskListNewCopy2Widget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in UserTaskListNewCopy2 widget.
